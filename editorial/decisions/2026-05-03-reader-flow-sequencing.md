...
- `developer-lens.md`, `portfolio-signal-lens.md`는 새 단계나 강제 템플릿이 아니라 공통 참고 관점으로 설계되어 있다. 당시 `series-pilab.md`도 기본 뼈대 후보로 언급했지만, 이후 [series-pilab 권한 낮추기](2026-05-03-series-pilab-deescalation.md) 결정으로 편집 렌즈가 아닌 시리즈 배경 메모로 격하했다.
