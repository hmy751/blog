...
- **독자 진입성과 스캔성**: 독자가 처음부터 끝까지 정독하지 않아도 글의 판단 흐름을 복구할 수 있는가. 소제목, 문단 첫 문장, 표/리스트/이미지/도식, 숫자 배치가 글의 핵심 질문과 판단 변화를 드러내는가. 자세한 기준은 [reader-flow-lens.md](reader-flow-lens.md)를 본다.
