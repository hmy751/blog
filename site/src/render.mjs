  ...
  return `<main class="view sys-page">
    <section class="sys-hero">
      <div>
        ...
        <h1 class="page-title">Markdown Surface</h1>
      </div>
      <p class="page-sub">` + "`Blog v2.html`" + `의 live shell 위에 ` + "`System.html`" + `의 prose primitive를 얹은 확인용 페이지입니다.</p>
    </section>
    <article class="prose">
      ${markdownToHtml(body, { leadFirstParagraph: true })}
    </article>
  </main>`;
}
