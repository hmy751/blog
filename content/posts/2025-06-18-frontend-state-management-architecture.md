...
service: 오라운드 (Oround)
cover: /images/posts/frontend-state-management-architecture/01-thumbnail.png
tags:
  - State Management
  - SWR
  - MobX
...
![dedupingInterval 적용 전 네트워크 재요청](/images/posts/frontend-state-management-architecture/03-dedupinginterval-before.gif)

Caption: dedupingInterval 적용 전

![dedupingInterval 적용 후 네트워크 요청 제어](/images/posts/frontend-state-management-architecture/04-dedupinginterval-after.gif)
...
![스켈레톤 적용 전 상품 목록 로딩 화면](/images/posts/frontend-state-management-architecture/05-skeleton-before.gif)

Caption: 스켈레톤 적용 전

![SWR 스켈레톤 적용 후 상품 목록 로딩 화면](/images/posts/frontend-state-management-architecture/06-skeleton-after.gif)
