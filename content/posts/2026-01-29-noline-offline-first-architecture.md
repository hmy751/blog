...
platform: Blog
project: Noline
cover: /images/posts/noline-offline-first-architecture/01-thumbnail.png
tags:
  - Offline-First
  - Local-First
  - SQLite
...
![Server-First와 Local-First 흐름 비교](/images/posts/noline-offline-first-architecture/02-server-first-vs-local-first.png)
...
![Selective Activation 아키텍처](/images/posts/noline-offline-first-architecture/03-selective-activation-architecture.png)
...
![사용자 플로우 타임라인](/images/posts/noline-offline-first-architecture/04-user-flow-timeline.png)
...
![Data와 Service 구분](/images/posts/noline-offline-first-architecture/05-data-vs-service.png)
...
![Policy Layer 4상태 매트릭스](/images/posts/noline-offline-first-architecture/06-policy-layer-matrix.png)
...
![동기화 전 비활성화로 데이터가 유실될 수 있는 시나리오](/images/posts/noline-offline-first-architecture/07-dangerous-data-loss-scenario.png)
...
![안전한 비활성화 플로우](/images/posts/noline-offline-first-architecture/08-safe-deactivation-flow.png)
...
![비활성 여행 카드와 오프라인 활성화 버튼](/images/posts/noline-offline-first-architecture/09-phone-trip-card-online-only.png)

![여행 활성화 전후 비교](/images/posts/noline-offline-first-architecture/10-phone-trip-activation-comparison.png)
...
![온라인 상태의 일정 화면](/images/posts/noline-offline-first-architecture/11-phone-online-schedule-google-map.png)

![오프라인 상태의 지도와 경로 화면](/images/posts/noline-offline-first-architecture/12-phone-online-offline-comparison.png)
...
![오프라인에서 장소 검색 대신 직접 입력을 안내하는 화면](/images/posts/noline-offline-first-architecture/13-phone-offline-guide-message.png)
