...
이 문서는 지금 살아 있는 후보와 각 후보의 현재 위상을 소유한다. 후보가 어떻게 생기고 평가가 어떻게 바뀌었는지는 [process](../../README.md)에 남기고, 여기에는 최신 중심 질문·근거·주장 상한·다음 shaping만 유지한다.

후보를 평가하는 현재 기준은 [criteria.md](../../../core/criteria.md)를 따른다. v1~v3와 review·main 판단을 대조해 아래 중심을 다시 맞춘 과정은 [post-v3 사용자 sync](../../shaping/2026-07-27-v1-v3-draft-loop/05-post-v3-reassessment-and-user-sync.md)가 보존한다.
...
첫 글과 후보의 최종 위상은 아직 확정하지 않는다. 상위 후보 다섯 개의 초기 draft loop 뒤 전체 자료를 대조하고 사용자와 중심을 다시 맞춘 결과는 [post-v3 사용자 sync](../../shaping/2026-07-27-v1-v3-draft-loop/05-post-v3-reassessment-and-user-sync.md)가 소유한다.
...
기존 [v3](../../shaping/2026-07-27-near-final-v2-v3/drafts/2026-07-27-near-final-v3/README.md)는 유효한 사실과 material을 가진 snapshot으로 보존했다. [public reshape cycle](../../shaping/2026-07-27-public-reshape/README.md)에서 [새 v1 다섯 편](../../../src/README.md), 독립 review와 [main 판정](../../shaping/2026-07-27-public-reshape/04-main-adjudication.md)을 완결했다.
...
- [v3](../../shaping/2026-07-27-v1-v3-draft-loop/drafts/v3/current-active-state-operation.md)의 Q1~Q5는 최근성 편향을 복구한 보강·한계 장면으로 사용하며 글 전체의 유일한 중심으로 고정하지 않는다.
...
- [재조사 전 상세 후보 snapshot](../../candidates/02-topic-candidates.md#후보-1-기록을-남겨도-프로젝트는-제어되지-않았다)
- [source-first 이후 중심과 상한](../../candidates/03-source-first-reanalysis.md#후보-1-current--active-state-operation)
...
- [v3](../../shaping/2026-07-27-v1-v3-draft-loop/drafts/v3/independent-review-and-recovery.md)의 9·15 검증 역할 표와 설치형 E2E가 기술적 중심을 충분히 닫는지 본다.
...
- [재조사 전 상세 후보 snapshot](../../candidates/02-topic-candidates.md#후보-2-테스트-9개가-모두-초록인데-제품은-아직-틀렸다)
- [source-first 이후 확장된 판별 계약](../../candidates/03-source-first-reanalysis.md#후보-2-독립-판별--제3판별자)
...
- [v3](../../shaping/2026-07-27-v1-v3-draft-loop/drafts/v3/product-flow-scope-control.md)의 raw `facts[]` 제안과 후속 실제 답변 경로는 이 경향을 보여 주는 중심 사건 후보로 유지한다.
...
- [source-first 통합 후보 카드](../../candidates/03-source-first-reanalysis.md#fresh-1-ai에게-작게-만들라고-했더니-제품-흐름이-사라졌다)
...
- [v3](../../shaping/2026-07-27-v1-v3-draft-loop/drafts/v3/judgment-order.md)에서 AI의 기준 오적용과 사용자의 정정이 직접 원천과 맞는지 계속 확인한다.
...
- [재조사 전 상세 후보 snapshot](../../candidates/02-topic-candidates.md#후보-3-좋은-평가-기준을-먼저-줬더니-ai의-후보가-전부-비슷해졌다)
- [source-first 이후 중심 변경](../../candidates/03-source-first-reanalysis.md#후보-3-평가-기준을-적용하는-시점)
...
- [03 이후 후보 상태 교정](../../candidates/04-post-03-candidate-state-correction.md)
...
- [v3](../../shaping/2026-07-27-v1-v3-draft-loop/drafts/v3/ai-self-check.md)의 전진 편향과 세 차례 사용자 제동은 발동·실패 장면으로 유지하되 글 전체의 유일한 중심으로 고정하지 않는다.
...
- [재조사 전 상세 후보 snapshot](../../candidates/02-topic-candidates.md#후보-4-ai-self-check는-답을-다시-쓰는-일이-아니다)
- [source-first 이후 강화된 한계](../../candidates/03-source-first-reanalysis.md#후보-4-ai-self-check)
...
- [재조사 전 상세 후보 snapshot](../../candidates/02-topic-candidates.md#후보-5-결과물을-뒤엎고도-기능은-살리는-법)
- [source-first 재조사의 부분 판정](../../candidates/03-source-first-reanalysis.md#후보-5-결과물-폐기와-기능-core-보존)
...
- [source-first 통합 후보 카드](../../candidates/03-source-first-reanalysis.md#fresh-2-기존-문서를-고치지-않고-원자료에서-다시-뽑은-이유)
...
- [source-first 통합 후보 카드](../../candidates/03-source-first-reanalysis.md#fresh-3-문제를-고르기-전에-결과를-먼저-만들어-봤다)
...
- [public-reshape-v1 다섯 편](../../../src/README.md)과 [독립 review index](../../shaping/2026-07-27-public-reshape/03-independent-reviews.md), [main 판정](../../shaping/2026-07-27-public-reshape/04-main-adjudication.md)을 사용자가 함께 검토한다.
