...
v3까지 작성과 독립 review 반영을 마친 뒤, 다섯 v3와 변화 기록을 종합 대조하고 사용자와 후보 중심을 다시 맞췄다. 그 결과는 [post-v3 사용자 sync](../shaping/2026-07-27-v1-v3-draft-loop/05-post-v3-reassessment-and-user-sync.md)에 보존한다.

초기 v1~v3는 완료된 비교 snapshot이다. 이후 버전은 이 폴더들을 고치거나 덮어쓰지 않고, 보정된 [active-state](../../active-state/index.md)를 따르는 별도 cycle로 만든다.

[material 종합과 사용자 sync](../shaping/2026-07-27-post-sync-v1/01-material-synthesis-and-user-sync.md) 뒤 [post-sync 새 v1 다섯 편](../shaping/2026-07-27-post-sync-v1/drafts/2026-07-27-post-sync-v1/README.md)을 만들고 독립 review와 main 판정까지 마쳤다. 사용자가 이 원고를 검토한 뒤에는 거의 최종본 수준까지 먼저 가 보기로 해, 별도 [전면 재작성 v2](../shaping/2026-07-27-near-final-v2-v3/drafts/2026-07-27-near-final-v2/README.md)와 [near-final v3](../shaping/2026-07-27-near-final-v2-v3/drafts/2026-07-27-near-final-v3/README.md)를 만들었다. 전체 과정은 [near-final cycle](../shaping/2026-07-27-near-final-v2-v3/README.md)에 보존한다.

사용자가 near-final v3를 실제 공개 블로그 글로 읽은 뒤에는 완료 판정을 되돌렸다. v2·v3는 당시 판단과 유효한 사실 교정을 복구하는 snapshot으로 그대로 보존했다. 기존 파일을 고치거나 v4로 잇지 않고 [public reshape cycle](../shaping/2026-07-27-public-reshape/README.md)의 판단에 따라 [public-reshape-v1 다섯 편](../../src/README.md)을 새로 완결했다.
...
- 현재 기준과 후보 상태는 [backlog active-state](../../active-state/index.md)가 소유한다.
- 버전별 review와 반영 판단은 [draft loop process](../shaping/2026-07-27-v1-v3-draft-loop/README.md)가 소유한다.
