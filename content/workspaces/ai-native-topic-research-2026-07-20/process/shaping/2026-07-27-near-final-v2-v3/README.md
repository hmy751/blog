...
1. 다섯 글의 중심은 [active-state](../../context-structure/legacy-active-state/topic-candidates.md)에서 가져온다.
...
- [전면 재작성 v2](./drafts/2026-07-27-near-final-v2/README.md)
- [near-final v3](./drafts/2026-07-27-near-final-v3/README.md)

## 현재 cursor

원천 재대조 뒤 다섯 중심은 유지했다. Self-check의 원천 불일치 장면을 교정하고, 각 글에 서로 다른 narrative engine과 public-safe artifact를 적용한 [전면 재작성 v2](./drafts/2026-07-27-near-final-v2/README.md)를 동결했다.

이어 독립 shaping·texture·evidence review, main 판정, v3 regression pass를 거쳐 [near-final v3 다섯 편](./drafts/2026-07-27-near-final-v3/README.md)을 완성했다. 링크·공개 경계·prepublish·production renderer 검증도 통과했다.
