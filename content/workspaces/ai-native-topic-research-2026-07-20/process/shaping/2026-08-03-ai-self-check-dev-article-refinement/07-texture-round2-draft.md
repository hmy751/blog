...
앞의 장면들에서 저는 AI가 만든 진단을 그대로 받거나 전부 버리지 않았습니다. 불확실성을 통제 가능한 데모로 바꾸려 했다는 분석은 좋다고 봤고, 구현 수단이 다시 중심에 놓이자 핵심은 그것이 아니라고 좁혔습니다. 6월의 한 분석 문서에서는 별도 AI가 문제를 더 좁혀 줬습니다. 넓은 진단은 작업 과정이 산출물에 샌다는 것, 좁힌 문제는 제작 과정을 정당화하는 설명이 결과와 상관없이 본문에 섞여 있다는 것이었습니다. 그 관점은 좋았지만, 주 작업 AI가 이를 옮긴 설명은 어렵고 지나치게 길다고 다시 고치게 했습니다.
