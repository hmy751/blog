...
- [core/criteria.md](../../core/criteria.md)는 반복해서 적용할 판단축을 소유한다.
- [active-state/index.md](../../active-state/index.md)는 현재 전체 그림과 열린 판단을 소유한다.
- [process/candidates/](../candidates/README.md)는 후보를 발견하고 재검토한 과정을 보여 준다.
- `process/shaping/`은 후보를 글의 단위로 시험한 과정을 보여 준다.
- 이전 산문은 관련 cycle의 `drafts/`, 최신 작업본은 [src](../../src/README.md)에 둔다.
...
보정된 중심으로 새 v1을 만든 뒤, 별도 [near-final cycle](./2026-07-27-near-final-v2-v3/README.md)에서 다섯 편 모두 v3와 독립 review·검증까지 완료했다. 그러나 공개 독자 재평가에서 `near-final` 판정을 철회했고, [public reshape cycle](./2026-07-27-public-reshape/README.md)에서 기존 중심을 유지한 새 완결 원고와 검토 기록을 만들었다. 이후 원고만 본 blind review도 별도 판단으로 추가했다. 현재 결정은 이 process index가 아니라 [active-state](../../active-state/index.md)가 소유한다.
