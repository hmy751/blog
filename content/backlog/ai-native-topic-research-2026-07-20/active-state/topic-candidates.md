...
현재 다음 행동은 기존 v1~v3를 고치는 것이 아니라 보정된 중심으로 새 cycle의 완결된 v1을 준비하는 일이다. 먼저 전체 자료를 종합하고 필요한 사실·자료 의미·권위·해석 질문을 사용자와 맞춘다. 새 v1 뒤에는 자동으로 v3까지 진행하지 않고 사용자와 다음 수정 범위와 버전 진행을 결정한다.
