...
공개상태: 내부 작업 문서
현재상태: material 종합·사용자 sync·결정 상태 회수 완료 / 새 v1 작성 준비
---
...
1. [active-state 기준](../../../active-state/criteria.md), [현재 후보 중심](../../../active-state/topic-candidates.md), [post-v3 사용자 sync](../2026-07-27-v1-v3-draft-loop/05-post-v3-reassessment-and-user-sync.md)
...
새 원고는 `content/drafts/ai-native-topic-research-2026-07-20/2026-07-27-post-sync-v1/`에 둔다. 이 index를 만들 때는 아직 초안 폴더를 만들지 않았다.
...
현재 cursor는 회수한 중심으로 새 v1 다섯 편을 쓰고, `02-v1-build-record.md`에 후보별 실행 판단을 남기는 일이다.
